...
public class TranslateActivity extends AppCompatActivity {
    ...
    public void translateText(View v) {
        ...
        TextView sourceTextLang= (TextView) findViewById(R.id.txt_source_lang);
        TextView outputTextLang= (TextView) findViewById(R.id.txt_output_lang);
        sourceLang =sourceTextLang.getText().toString() ;
        outputLang =outputTextLang.getText().toString() ;
        ...
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang=" + sourceLang +"-"+outputLang+"&[format=plain]&[options=1]&[callback=set]";//The API service URL
